...
public class Filtering {
    ...
    public static double[][] computeFRBlock(double[][] frequency, int block, double sigmaR) {
    ...
    public static double[][] computeFABlock(double[][] orientation, double[][] coherence, int block) {
